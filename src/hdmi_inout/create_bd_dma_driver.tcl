...
# module references:
# axi4stream_input_buffer, axi4stream_output_buffer, chunk_transposer_wrapper, inverse_chunk_transposer_wrapper, standalone_resolution_upscaler
...
xilinx.com:hls:dma_master_driver:1.0\
...
standalone_resolution_upscaler\
"
...
proc create_root_design { parentCell } {
  ...
  set hdmi_in_rx_txen [ create_bd_port -dir O -from 0 -to 0 hdmi_in_rx_txen ]
  ...
  # Create instance: axi4stream_input_buf_0, and set properties
  set block_name axi4stream_input_buffer
  set block_cell_name axi4stream_input_buf_0
  if { [catch {set axi4stream_input_buf_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi4stream_input_buf_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.AXI_WIDTH {128} \
   CONFIG.BUFFER_WIDTH {6144} \
   CONFIG.LAST_PACKET_WIDTH {128} \
 ] $axi4stream_input_buf_0

  # Create instance: axi4stream_output_bu_0, and set properties
  set block_name axi4stream_output_buffer
  set block_cell_name axi4stream_output_bu_0
  if { [catch {set axi4stream_output_bu_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi4stream_output_bu_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.AXI_WIDTH {128} \
   CONFIG.BUFFER_WIDTH {13824} \
   CONFIG.LAST_PACKET_WIDTH {128} \
   CONFIG.NUM_PACKETS {108} \
   CONFIG.NUM_PACKETS_PER_TXN {36} \
 ] $axi4stream_output_bu_0
  ...
  # Create instance: chunk_transposer_wra_0, and set properties
  set block_name chunk_transposer_wrapper
  set block_cell_name chunk_transposer_wra_0
  if { [catch {set chunk_transposer_wra_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $chunk_transposer_wra_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: dma_master_driver_0, and set properties
  set dma_master_driver_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:dma_master_driver:1.0 dma_master_driver_0 ]
  ...
  # Create instance: inverse_chunk_transp_0, and set properties
  set block_name inverse_chunk_transposer_wrapper
  set block_cell_name inverse_chunk_transp_0
  if { [catch {set inverse_chunk_transp_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $inverse_chunk_transp_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.CELL_SIZE {3} \
 ] $inverse_chunk_transp_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_DCACHE_HIGHADDR {0x000000008007FFFF} \
   CONFIG.C_DEBUG_ENABLED {1} \
   CONFIG.C_D_AXI {1} \
   CONFIG.C_D_LMB {1} \
   CONFIG.C_ICACHE_HIGHADDR {0x000000008007FFFF} \
   CONFIG.C_I_LMB {1} \
  ...
  # Create instance: standalone_resolutio_0, and set properties
  set block_name standalone_resolution_upscaler
  set block_cell_name standalone_resolutio_0
  if { [catch {set standalone_resolutio_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $standalone_resolutio_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net S04_AXI_1 [get_bd_intf_pins axi_mem_intercon/S04_AXI] [get_bd_intf_pins axi_vdma_0/M_AXI_MM2S]
  connect_bd_intf_net -intf_net S07_AXI_1 [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_mem_intercon/S07_AXI]
  connect_bd_intf_net -intf_net axi4stream_output_bu_0_interface_axis [get_bd_intf_pins axi4stream_output_bu_0/interface_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi4stream_input_buf_0/interface_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon/S08_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins axi_mem_intercon/S01_AXI]
...
connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_interconnect_0_M05_AXI]
  ...
  connect_bd_intf_net -intf_net dma_master_driver_0_m_axi_dma0 [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins dma_master_driver_0/m_axi_dma0]
connect_bd_intf_net -intf_net [get_bd_intf_nets dma_master_driver_0_m_axi_dma0] [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets dma_master_driver_0_m_axi_dma0]
  connect_bd_intf_net -intf_net dma_master_driver_0_m_axi_dma1 [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins dma_master_driver_0/m_axi_dma1]
connect_bd_intf_net -intf_net [get_bd_intf_nets dma_master_driver_0_m_axi_dma1] [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets dma_master_driver_0_m_axi_dma1]
  ...
  # Create port connections
  connect_bd_net -net axi4stream_input_buf_0_myBuffer [get_bd_pins axi4stream_input_buf_0/myBuffer] [get_bd_pins chunk_transposer_wra_0/video_chunk]
  connect_bd_net -net axi4stream_input_buf_0_valid [get_bd_pins axi4stream_input_buf_0/valid] [get_bd_pins axi4stream_output_bu_0/input_buffer_valid]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins dma_master_driver_0/frame_trigger_V]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins microblaze_0/Interrupt]
  connect_bd_net -net axi_vdma_0_s2mm_frame_ptr_out [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins axi_vdma_0/s2mm_frame_ptr_out]
  ...
  connect_bd_net -net chunk_transposer_wra_0_processing_chunk [get_bd_pins chunk_transposer_wra_0/processing_chunk] [get_bd_pins standalone_resolutio_0/processor_packed_input]
  connect_bd_net -net dma_master_driver_0_dma_programmed_V [get_bd_pins system_ila_0/probe0]
  ...
  connect_bd_net -net dvi2rgb_0_pLocked [get_bd_pins dvi2rgb_0/pLocked] [get_bd_pins proc_sys_reset_1/dcm_locked]
  ...
  connect_bd_net -net inverse_chunk_transp_0_video_chunk [get_bd_pins axi4stream_output_bu_0/input_buffer] [get_bd_pins inverse_chunk_transp_0/video_chunk]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi4stream_input_buf_0/aclk] [get_bd_pins axi4stream_output_bu_0/aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins axi_mem_intercon/S05_ACLK] [get_bd_pins axi_mem_intercon/S06_ACLK] [get_bd_pins axi_mem_intercon/S07_ACLK] [get_bd_pins axi_mem_intercon/S08_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net microblaze_0_Clk_2 [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins dma_master_driver_0/ap_clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins dvi2rgb_0/aRst_n] [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi4stream_input_buf_0/areset] [get_bd_pins axi4stream_output_bu_0/areset] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins dma_master_driver_0/ap_rst_n] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net standalone_resolutio_0_processor_packed_output [get_bd_pins inverse_chunk_transp_0/processing_chunk] [get_bd_pins standalone_resolutio_0/processor_packed_output]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins mig_7series_0/sys_clk_i]
  connect_bd_net -net v_axi4s_vid_out_0_underflow [get_bd_ports led] [get_bd_pins v_axi4s_vid_out_0/underflow]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports hdmi_in_hpd] [get_bd_ports hdmi_in_rx_txen] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins axi_mem_intercon/S05_ARESETN] [get_bd_pins axi_mem_intercon/S06_ARESETN] [get_bd_pins axi_mem_intercon/S07_ARESETN] [get_bd_pins axi_mem_intercon/S08_ARESETN] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41E00000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma0] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma0] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma0/SEG_axi_gpio_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x40600000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma0] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma0/SEG_axi_uartlite_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma0] [get_bd_addr_segs axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma0/SEG_axi_vdma_0_Reg]

  create_bd_addr_seg -range 0x20000000 -offset 0x80000000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma0] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma0/SEG_mig_7series_0_memaddr]

  create_bd_addr_seg -range 0x00010000 -offset 0x41E00000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma1] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma1/SEG_axi_dma_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma1] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma1/SEG_axi_gpio_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x40600000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma1] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma1/SEG_axi_uartlite_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma1] [get_bd_addr_segs axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma1/SEG_axi_vdma_0_Reg]

  create_bd_addr_seg -range 0x20000000 -offset 0x80000000 [get_bd_addr_spaces dma_master_driver_0/Data_m_axi_dma1] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  exclude_bd_addr_seg [get_bd_addr_segs dma_master_driver_0/Data_m_axi_dma1/SEG_mig_7series_0_memaddr]
