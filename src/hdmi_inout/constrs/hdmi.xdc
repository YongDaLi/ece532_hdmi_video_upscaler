...
create_clock -period 10.000 -name sys_clk_i -waveform {0.000 5.000} -add [get_ports sys_clock];
...
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { hdmi_in_rx_txen }]; #IO_L3P_T0_DQS_34 Sch=hdmi_rx_txen
