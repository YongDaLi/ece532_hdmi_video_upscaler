set moduleName transfer_chunk_1
...
set C_modelName {transfer_chunk.1}
...
set C_modelArgMapList {[ 
	{ "Name" : "dma", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "col", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ row sc_in sc_lv 10 signal 1 } 
	{ col sc_in sc_lv 11 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "col", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "col", "role": "default" }}  ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "dma", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_transfer_1_fu_75", "Port" : "dma"}]},
			{"Name" : "row", "Type" : "None", "Direction" : "I"},
			{"Name" : "col", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_transfer_1_fu_75", "Parent" : "0",
		"CDFG" : "transfer_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
