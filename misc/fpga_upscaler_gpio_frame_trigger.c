...
void setup_vdma() {
    ...
    vdma_membase[0x60 / sizeof(uint32_t)] = OUTPUT_FB_0;  // second frame buffer

    /* MM2S_FRMDLY_STRIDE */
    vdma_membase[0x58 / sizeof(uint32_t)] = OUTPUT_FRAME_WIDTH * PIXEL_SIZE_BYTE;
    // MM2S_HSIZE (in bytes)
    vdma_membase[0x54 / sizeof(uint32_t)] = 1920 * PIXEL_SIZE_BYTE;
...
void gpio_new_frame_ISR() {
    ...
    gpio_membase[0x0008 / sizeof(uint32_t)] = 0x01;
    gpio_membase[0x0008 / sizeof(uint32_t)] = 0x00;
