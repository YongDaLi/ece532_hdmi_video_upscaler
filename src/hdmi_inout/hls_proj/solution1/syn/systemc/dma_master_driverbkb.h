...
// ==============================================================
#ifndef __dma_master_driverbkb__HH__
#define __dma_master_driverbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dma_master_driverbkb) {
    ...
    SC_CTOR(dma_master_driverbkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
