...
#
# Generated by Vivado on Wed Feb 15 23:44:07 -0500 2023
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../../AppData/Roaming/Xilinx/Vivado/project"]"
...
set files [list \
 [file normalize "${origin_dir}/src/hdl/pixel_average.sv"] \
 [file normalize "${origin_dir}/src/hdl/types.sv"] \
 [file normalize "${origin_dir}/src/hdl/resolution_upscaler_cell.sv"] \
 [file normalize "${origin_dir}/src/hdl/resolution_upscaler_chunk.sv"] \
 [file normalize "${origin_dir}/src/hdl/frame_interpolator_averaging.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/hdl/pixel_average.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/hdl/types.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/hdl/resolution_upscaler_cell.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/hdl/resolution_upscaler_chunk.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/hdl/frame_interpolator_averaging.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "resolution_upscaler_chunk" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/sims/tb_resolution_upscaler_cell.sv"] \
 [file normalize "${origin_dir}/sims/tb_frame_interpolation.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/sims/tb_resolution_upscaler_cell.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/sims/tb_frame_interpolation.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_resolution_upscaler_cell" -objects $obj
